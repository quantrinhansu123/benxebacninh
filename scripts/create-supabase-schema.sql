...
CREATE TABLE IF NOT EXISTS dispatch_records (
  ...
  entry_by TEXT REFERENCES users(id),
  entry_by_name VARCHAR(255),
  entry_shift_id UUID REFERENCES shifts(id),
  entry_image_url TEXT,
  passenger_drop_time TIMESTAMPTZ,
  passengers_arrived INTEGER,
  passenger_drop_by TEXT REFERENCES users(id),
  passenger_drop_by_name VARCHAR(255),
  boarding_permit_time TIMESTAMPTZ,
  boarding_permit_by TEXT REFERENCES users(id),
  boarding_permit_by_name VARCHAR(255),
  permit_shift_id UUID REFERENCES shifts(id),
  ...
  payment_by TEXT REFERENCES users(id),
  payment_by_name VARCHAR(255),
  payment_shift_id UUID REFERENCES shifts(id),
  departure_order_time TIMESTAMPTZ,
  passengers_departing INTEGER,
  departure_order_by TEXT REFERENCES users(id),
  departure_order_by_name VARCHAR(255),
  departure_order_shift_id UUID REFERENCES shifts(id),
  exit_time TIMESTAMPTZ,
  exit_by TEXT REFERENCES users(id),
  exit_by_name VARCHAR(255),
  exit_shift_id UUID REFERENCES shifts(id),
